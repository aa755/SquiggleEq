...
Lemma sub_filter_app_as_remove_nvars :
  forall (sub : @Substitution Opid) l1 l2,
...
Proof using Type* gts.
  ...
  - Case "oterm".
    ...
    remember (@sub_mk_renames2 _ _ _ _ Opid lv (sub_free_vars sfio) (dom_sub sfio ++ all_vars nt) ) as H99.
